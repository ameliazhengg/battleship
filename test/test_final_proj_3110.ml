...
let test_logic =
  "test suite for logic.ml"
  >::: [
         ( "check add_user_correct_guess" >:: fun _ ->
           assert_equal [] !user_guesses );
         ( "check get_user_correct_guess" >:: fun _ ->
           assert_equal [] (get_correct_user_guess ()) );
         ( "check get_user_incorrect_guess" >:: fun _ ->
           assert_equal [] (get_incorrect_user_guess ()) );
       ]
